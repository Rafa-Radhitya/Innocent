...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($userPrompt)) {
        $prompt = "You are a helpful assistant that provides guidance and information about games. Please answer the user's questions clearly and helpfully. If the user asks for a list, provide it in bullet points.\n\nUser: $userPrompt\nAI:";
        ...
        curl_setopt_array($ch, [
            ...
            CURLOPT_POSTFIELDS => json_encode([
                'model' => 'gpt-3.5-turbo',
                'messages' => [
                    ['role' => 'system', 'content' => 'You are a helpful assistant that provides guidance and information about games.'],
...
<body>
    <div class="sidebar">
        <h1><span class="bola">Innocent</span><span class="ku"></span></h1>
        <ul>
            <li><a href="/Innocent/Innocent/tampilan/index.php">Home</a></li>
        </ul>
    </div>
    <div class="content">
