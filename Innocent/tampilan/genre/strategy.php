...
Tugas Anda dan tim adalah menjaga agar tempat tidur di pulau milik Anda tak dihancurkan lawan. Nah, sementara Anda dan rekan-rekan satu tim harus memikirkan strategi untuk menghancurkan tempat tidur dan pulau musuh.</p>
        ...
        <div class="card">
            <div class="image">
                <img src="../images/fm.webp" alt="">
            </div>
            <h2>Footbal Manager 2024</h2>
            <p>Release date: nov 6, 2023</p>
            <p>By: Sport Interactive</p>
            <p>Football Manager 2024 is a football management simulation game developed by Sports Interactive and published by SEGA. Known for its depth and realism, it allows players to take on the role of a football club manager, making strategic decisions both on and off the pitch to lead their team to success.</p>
            <a href="#">Read More</a>
        </div>
        <div class="card">
            <div class="image">
